...
<body>
    ...
    <div class="container">
        ...
        <section class="hero">
            <h1 class="hero__title">Welcome to UZWRITER.UZ</h1>
        ...
        <section class="features">
            <p class="hero__subtitle">UZWRITER.UZ is an online platform dedicated to helping individuals learn English
                ...
                you're a beginner or looking to enhance your proficiency, UZWRITER.UZ has the right tools to assist you
